...
//         $("#login-username-err").hide();
//     });
//     $(".login_form #password").focus(function(){
//         $("#login-password-err").hide();
//     });
//
//     $(".register_form #username").focus(function(){
...
//
// 		// 取到用户输入的内容
//         var username = $("#register_username").val();  // 提取手机号
...
//     if (!username) {
//         $("#register-username-err").html("请填写正确的手机号！");
//         $("#register-username-err").show();
//         $(".get_code").attr("onclick", "sendSMSCode();");
//         return;
//     }
